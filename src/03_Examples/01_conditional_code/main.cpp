...
int main() {
    set_benchmark_suite("03_Examples/01_conditional_code");
	...
	benchmark_comparison("Clamping", scalar_clamp, simd_clamp, 200);
	std::cout << std::endl;
	...
	// Benchmark comparison
	benchmark_comparison("Filtering", scalar_filter, simd_filter, 200);
	std::cout << std::endl;
	...
	// Benchmark comparison
	benchmark_comparison("Complex Filtering", scalar_complex, simd_complex, 200);
	std::cout << std::endl;
